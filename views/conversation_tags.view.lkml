view: conversation_tags {
  ...
  dimension: brand {
    ...
    case: {
      ...
      when: {sql:  ${tags} LIKE "%parameter:tfn_company:avg %" OR ${tags} LIKE "%parameter:brandname:A V G%" OR ${tags} LIKE "%parameter:brandname:avg%";;        label: "AVG"}
      else: "Other"
    }
  }
...
dimension: routing_queue_nlok {
  ...
  case: {
    ...
    when: {sql:  ${tags} LIKE "%parameter:menu_id:542%";;                 label: "Chat: threat"}
